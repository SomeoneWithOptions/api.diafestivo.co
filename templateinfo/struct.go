...
func NewTemplateInfo(name string, is_today bool, days_until int, date time.Time, gif_url *string, day int, month string, year int, week_day string) TemplateInfo {
